...
Курс живёт благодаря студентам, которые улучшают его. Первый большой вклад — ревизия и реструктуризация всего курса (методологический аудит 150+ пунктов, тесты `tests/`, итоговый проект `capstone/`, задания `exercises/`, реорганизация материалов) — [@lobovski11-ui](https://github.com/lobovski11-ui), ветка [codex/course-revision-and-structure](https://github.com/lobovski11-ui/stats-ab-course/tree/codex/course-revision-and-structure), 2026. Хотите помочь — форкните репозиторий и откройте pull request.
