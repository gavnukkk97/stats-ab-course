...
Запуск из корня репозитория: python3 course/modules/M7/practice/practice_7_4.py
...
fig.tight_layout()
fig.savefig(IMAGE_DIR / "practice_7_4_calendar.png", dpi=150, bbox_inches="tight")
plt.close(fig)
...
fig.tight_layout()
fig.savefig(IMAGE_DIR / "practice_7_4_velocity.png", dpi=150, bbox_inches="tight")
plt.close(fig)
