...
Запуск из корня репозитория: python3 course/modules/M5/practice/practice_5_4.py
...
fig.tight_layout()
fig.savefig(IMAGE_DIR / "practice_5_4_regret.png", dpi=150)
plt.close(fig)
...
fig.tight_layout()
fig.savefig(IMAGE_DIR / "practice_5_4_promo.png", dpi=150)
plt.close(fig)
...
fig.tight_layout()
fig.savefig(IMAGE_DIR / "practice_5_4_nonstationary.png", dpi=150)
plt.close(fig)
