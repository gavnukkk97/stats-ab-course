...
Запуск:  python3 practice_1_4.py
...
print("   Истинная медиана 800 руб. — накрыта интервалом медианы.")
...
fig.tight_layout()
fig.savefig(HERE / "bootstrap_checks.png", dpi=150)
...
ax.grid(alpha=0.3)
fig.tight_layout()
fig.savefig(HERE / "bootstrap_qq_median.png", dpi=150)
...
print(f"1) Медиана: {median_hat:,.0f} руб., 95% CI [{ci_med[0]:,.0f}; {ci_med[1]:,.0f}] "
      f"— истинная медиана 800 руб. внутри.")
...
print("   у скошенной метрики медиана оценивается стабильнее среднего.")
