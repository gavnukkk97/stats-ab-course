...
# Запуск: python3 make_visuals_nav.py  → course_route.png + "LAYOUT OK"
import matplotlib
matplotlib.use("Agg")
...
box("m4", 17.25, Y0, W, H, "М4 · АБ на практике\n6 уроков · ~3 нед\nкейсы: 04·06·07·10·13·15", C_CORE, fs=9.2)
...
ax.text(9.8, 4.85, "трек продакта: без формул — М1.1, М2.1, потом весь М4 + кейсы",
...
ax.text(15.0, 12.7, "полный трек ≈ 16 недель по 3–5 ч/нед; кейсы — «зачёт» модуля (карта: course/cases/README.md)",
        ha="center", fontsize=10, color="#555", style="italic")

ax.text(24.3, 13.2, "— опорные пункты\n-- зелёный: экспресс\n-- оранжевый: продакт", fontsize=9, color="#555", va="top")

fig.savefig("course_route.png", bbox_inches="tight", dpi=150)
