...
Запуск:  python3 practice_5_1.py
...
fig.tight_layout()
fig.savefig(HERE / "practice_5_1_sequential.png", dpi=150)
plt.close(fig)
...
fig.tight_layout()
fig.savefig(HERE / "practice_5_1_priors_fade.png", dpi=150)
plt.close(fig)
...
axes[0].set_title(f"Распределение восстановлено: {extreme:.0%} монет с MLE 0%/100%\n"
...
fig.suptitle("Empirical Bayes: априор из истории двора + 20 бросков данных",
             fontsize=12, fontweight="bold")
fig.tight_layout()
fig.savefig(HERE / "practice_5_1_empirical_bayes.png", dpi=150)
plt.close(fig)
...
print("4) Empirical Bayes: априор из истории (Beta(6,4)) усаживает сумасшедшие")
