...
Запуск:  python3 practice_5_2.py
...
fig.tight_layout()
fig.savefig(HERE / "practice_5_2_ci_vs_cri.png", dpi=150)
plt.close(fig)
...
fig.tight_layout()
fig.savefig(HERE / "practice_5_2_base_rate.png", dpi=150)
plt.close(fig)
...
fig.tight_layout()
fig.savefig(HERE / "practice_5_2_p_b_over_a.png", dpi=150)
plt.close(fig)
